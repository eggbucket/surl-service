...
public class ShortUrlService {
    ...
    public List<Map<String, String>> makeShortUrl(List<String> urls_long) throws AppException {
        ...
        slog.info("origin urls_long is " + urls_long.toString());
        ...
        for (String url : urls_long) {
            ...
            if (old_code != null) {
                ...
                ret_maps.add(item_map);
                slog.info(" get ret_maps from redis :" + ret_maps);
            } else {
                try {
                ...
                slog.info("long_code is " + long_code + "      transform code is " + code);
                ...
                slog.info("ret_todb is " + ret_todb);
                ret_maps.add(item_map);
                slog.info("ret_maps is " + ret_maps);
            }
            try {
    ...
    public Integer getClickTimes(String code) throws AppException {

        return urlsDao.getClickTimes(code);
    }
